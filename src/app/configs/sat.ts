...
export const amazoniaConfig: BranchConfig = {
  name: 'amazonia',
  displayName: 'AClimate Amazonia',
  aboutUs: {
    title: 'Sobre la herramienta',
    description: `AClimate Amazonia es una plataforma especializada en el análisis de datos climáticos espaciales para la región amazónica.
Integra información satelital de múltiples fuentes para proporcionar datos históricos y análisis climatológicos que apoyan la investigación y gestión ambiental en la Amazonía.`,
    ...
    projectDescription: `AClimate Amazonia se enfoca en el procesamiento y análisis de datos climáticos satelitales para la región amazónica. Utiliza tecnologías avanzadas de procesamiento de datos espaciales para transformar información cruda de sensores remotos en productos climáticos de alta calidad.
